...
public class ThreeNoteAuto extends SequentialCommandGroup {
        public ThreeNoteAuto(Swerve s_Swerve, ShooterSubsystem shooterSubsystem, KickerSubsystem kickerSubsystem,
                ...
                Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(
                                ...
                                List.of(new Translation2d(-1.0, -0.01), new Translation2d(-2.0, 0)),
                ...
                Trajectory secondTrajectory = TrajectoryGenerator.generateTrajectory(
                                // Start at the origin facing the +X direction
                                new Pose2d(-3.0, -0.01, new Rotation2d(1.570796)),
                                // Pass through these two interior waypoints, making an 's' curve path
                                List.of(new Translation2d(0, -.5), new Translation2d(0, 0)),
                                // End 3 meters straight ahead of where we started, facing forward
                                new Pose2d(0, -1, new Rotation2d(0)), // 1.570796 radian = 90 degrees
                                config);
                ...
                addCommands(
                                ...
                                swerveControllerCommand.alongWith(new IntakeAndKickerCMD(intakeAndKickerSubsystem,
                                                VoltageConstants.vk_KickerForward, VoltageConstants.vk_IntakeForward,
                                                kickerSubsystem)), //
