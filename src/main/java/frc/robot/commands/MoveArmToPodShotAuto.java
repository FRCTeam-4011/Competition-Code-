...
public class MoveArmToPodShotAuto extends Command {
  /** Creates a new MoveArmToPodShotCMD. */
  private final ArmSubsystem armSubsystem;
  private double armVolts;

  public MoveArmToPodShotAuto(ArmSubsystem armSubsystem, double armVolts) {
  ...
  public boolean isFinished() {
    if (armSubsystem.getArmEncoderPOS() == EncoderConstants.ek_PodiumShotArmPOSAuto) {
      return true;
    } else {
      return false;
    }
